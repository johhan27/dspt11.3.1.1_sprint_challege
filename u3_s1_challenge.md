...
- What, in your opinion, is an important part of code reviews? That is, what is
  ...
  when others do the same for your code?
    ...
    "I usually pay attention to the readability, simplicity and modularity. I appreciate when someone points out a better way to implement something in my code or even renaming some variables and functions"

- We have an awful lot of computers here, and it gets pretty confusing with
  slightly different things running on all of them. How could containers help us
  improve this situation?

  "Implementing containers allows us all to work on the same environment, having everything that our project needs in order to run; therefore, following up on everyone's system would no longer be necessary"
